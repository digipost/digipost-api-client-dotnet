...
namespace Digipost.Api.Client.Test.Api
{
    public class DigipostApiTests
    {
        public class ValidateMethod
        {
            ...
            public void InvalidMessageXmlThrowsException()
            {
                ...
                Assert.Throws<XmlException>(() => DigipostApi.ValidateXml(messageXmlDocument));
            }
            ...
            public void InvalidIdentificationXmlThrowsException()
            {
                ...
                Assert.Throws<XmlException>(() => DigipostApi.ValidateXml(identificationXmlDocument));
            }
        }
    }
}