    ...
    public class SerializeUtilTests
    {
        ...
        public class DeserializeMethod
        {
            ...
            public void ReturnsProperDeserializedMessage()
            {
                ...
                var attachment =  new Invoice("Subject", "txt", TestHelper.GetBytes("test"),100,"18941362738",DateTime.Parse("2018-01-01"),"123123123123", AuthenticationLevel.TwoFactor,
        ...
        public class SerializeMethod
        {
            ...
            {
                //Arrange
                var invoice = new Invoice("Subject", "txt", TestHelper.GetBytes("test"),100,"18941362738",DateTime.Parse("2018-01-01"),"123123123123", AuthenticationLevel.TwoFactor,
                    SensitivityLevel.Sensitive) { Guid = "123456", SmsNotification = new SmsNotification(2) };
