...
With version 8.3 of the Digipost API, messages can have extra bits of computer readable information that
...
In this example, an event-datatype that allows for certain calendar-related functions is added to a
message. Events are basically Appointments that span multiple time intervals.
In this example the Event is during Saturday 9 AM to 4 PM & Sunday 10 AM to 2 PM.
